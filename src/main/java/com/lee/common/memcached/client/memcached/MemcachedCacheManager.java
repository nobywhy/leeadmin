...
import com.lee.common.memcached.client.memcached.client.ErrorHandler;
import com.lee.common.memcached.client.memcached.client.MemCachedClient;
import com.lee.common.memcached.client.memcached.client.SockIOPool;
...
public class MemcachedCacheManager implements ICacheManager<IMemcachedCache>
{
	...
	/* (non-Javadoc)
	 * @see com.zaocoo.sns.memcached.clinet.ICacheManager#start()
	 */
	public void start()
	{
	...
	protected void initMemCacheClientPool()
	{
		...
		for(MemcachedClientConfig node : memcachedClientconfigs)
		{
			...
			client.setCompressThreshold(node.getCompressThreshold());
	...
	public void addCache(String name, IMemcachedCache cache) {
		getCachepool().put(name, cache);
	}
	...
	public Set<String> getCacheNameSet() {
		return getCachepool().keySet();
	}
	
	/* (non-Javadoc)
	 * @see com.zaocoo.sns.memcached.clinet.ICacheManager#stop()
	 */
	public void stop()
	{
