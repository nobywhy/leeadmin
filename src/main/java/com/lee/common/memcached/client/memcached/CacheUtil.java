...
import com.lee.common.memcached.client.ICache;
import com.lee.common.memcached.client.ICacheManager;
import com.lee.common.memcached.client.memcached.impl.DefaultCacheImpl;
			...
			while(r.hasNext())
			{
				...
				if (event.isStartElement())
				{
					...
					if (tag.equalsIgnoreCase("client"))
					{
						...
						if (start.getAttributeByName(new QName("","compressThreshold")) != null)
							node.setCompressThreshold(Long.parseLong(
									start.getAttributeByName(new QName("","compressThreshold")).getValue()));
						else
							node.setCompressThreshold(5120L);
